...
static int ov5640_get_sysclk(struct ov5640_dev *sensor)
{
	...
	printk(KERN_ERR "sjb: ov5640: %s: sysclk=%d VCO=%d\n", __func__, sysclk, VCO);
	return sysclk;
}
...
static int ov5640_check_chip_id(struct ov5640_dev *sensor)
{
	...
	int ret = 0;
	u16 chip_id;
	printk(KERN_ERR "sjb: ov5640: %s: entered, powering on\n", __func__);
	ret = ov5640_set_power_on(sensor);
	if (ret)
		return ret;
...
power_off:
	printk(KERN_ERR "sjb: ov5640: %s: Done, powering off\n", __func__);
	ov5640_set_power_off(sensor);
	return ret;
}
			...
			const struct i2c_device_id *id)
{
	...
	if (ret)
		goto free_ctrls;
	printk(KERN_ERR "sjb: ov5640: %s: Powered on!\n", __func__);

	ret = v4l2_async_register_subdev(&sensor->sd);
	if (ret)
		goto free_ctrls;

	printk(KERN_ERR "sjb: ov5640: %s: Done!\n", __func__);
	return 0;
